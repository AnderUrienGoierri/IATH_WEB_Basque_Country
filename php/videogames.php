...
$t = [
    'en' => [
        'title' => 'Catalog - GameMatch AI',
        'home' => 'Home',
        'videogames' => 'Videogames',
        'catalog_title' => 'Game Catalog',
        'catalog_subtitle' => 'Explore our full collection of titles.',
        'showing' => 'Showing',
        'results' => 'results',
    ...
    'es' => [
        ...
        'catalog_title' => 'Catálogo de Juegos',
        'catalog_subtitle' => 'Explora nuestra colección completa de títulos analizados por la IA.',
        'showing' => 'Mostrando',
        'results' => 'resultados',
                ...
                <a href="videogame_details.php?id=<?php echo $row['id']; ?>" class="game-link"
                   ...
                   data-origin="<?php echo htmlspecialchars($row['originated']); ?>"> 
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-desc">
                            <?php echo !empty($row["game_description"]) ? htmlspecialchars($row["game_description"]) : $txt['no_desc']; ?>
                        </p>
